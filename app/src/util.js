    ...
    checkValidatePath(path) {
        return (
            (
                ...
                || path.indexOf(CONFIG.app.pathSteam)       !== -1
                || path.indexOf(CONFIG.app.pathArkmanager)  !== -1
    ...
    convertArray(array) {
        if(Array.isArray(array))
            array.forEach((value, key) => {
                ...
                else if(array[key].toString().toLowerCase() === 'false' || array[key] === false) {
                    array[key] = false
                }
                else if(array[key].toString().toLowerCase() === 'true' || array[key] === true) {
                    array[key] = true
                }
    ...
    convertObject(obj) {
        if(typeof obj === "object")
            Object.keys(obj).forEach((key) => {
                ...
                else if(obj[key].toString().toLowerCase() === 'false' || obj[key] === false) {
                    obj[key] = false
                }
                else if(obj[key].toString().toLowerCase() === 'true' || obj[key] === true) {
                    obj[key] = true
                }
