...
router.route('/')
   ...
   .all((req,res)=>{
      ...
      if(!userHelper.hasPermissions(req.session.uid, "show", serverName) || !userHelper.hasPermissions(req.session.uid, "saves/show", serverName)) {
         res.redirect("/401")
         return true
      }
      ...
      // Render Seite
      res.render('pages/servercenter/serverCenter_saves', {
          userID                  : req.session.uid,
          page                    : "servercenter_saves",
          response                : response,
          lang                    : lang,
          ...
          breadcrumb      : [
              ...
              serverName,
              lang.breadcrumb["servercenter_saves"],
          ]
      });
   })
